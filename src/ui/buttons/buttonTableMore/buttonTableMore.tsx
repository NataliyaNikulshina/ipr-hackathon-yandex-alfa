...
const ButtonTableMore: FC<IButtonTableMore> = ({ onClick, rotate, color, width = 33, height = 37 }) => (
    <button
        type="button"
        onClick={onClick}
        style={(rotate) ? { backgroundColor: "transparent", border: "none", alignSelf: "center", transform: 'rotate(180deg)', transition:'transform .6s'} : { backgroundColor: "transparent", border: "none", alignSelf: "center", transition:'transform .6s' }}
    >
